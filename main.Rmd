...
* **"Vendas-dia"** - Dados relativos à venda diária das embarcações em cada lota. Estes dados são recolhidos pela Docapesca e compilados pela Direcção Geral de Recursos Marinhos (DGRM), que por seu turno os cede ao Instituto Português do Mar e da Atmosfera. Apresentam a vantagem de poder ser agregados à escala temporal desejada (realisticamente, desde semanais a anuais). Com base nestes dados duas séries temporais serão extraídas: desembarques (kg) e esforço de pesca (unidade a determinar, ver abaixo). A informação adicional constante no data set permite a divisão por arte de pesca (artesanal vs cerco vs arrasto), porto de desembarque, região (NW, SW, S), segmento de frota (com base no comprimento fora-a-fora, LOA), entre outros.
