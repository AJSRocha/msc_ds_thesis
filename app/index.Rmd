...
# dts.train = reactive({dados()[1:(length(dados())-input$cutoff)]})
# dts.test = reactive({dados()[(length(dados())-input$cutoff+1):length(dados())]})
# dts.test = reactive({tail(dados(), input$cutoff)})
...
plot(ts_m_S, col = 'red', xlim = c(2010,2022))
