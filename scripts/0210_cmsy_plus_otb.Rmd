...
id = data.frame(Continent = 'Europe',
                Region = 'Iberia',
                Subregion = 'Portugal',
                Stock = "1-Western Coast 2-Bottom Trawl",
                Group = 'Cephalopoda',
                Name = 'Octopus',
...
stocks = "1-Western Coast 2-Bottom Trawl"
...
for(stock in stocks) {
 ...
 #   bt           <- bt.raw
  ...
  time_f = Sys.time()
  perf_cmsy_fit_otb_w = time_f - time_i
...
time_f = Sys.time()
perf_cmsy_render_otb_w = time_f - time_i
check = time_f - total_i

```

```{r}
perf_cmsy_w_otb = data.frame('Framework' = 'CMSY++ - Bottowm Trawl, Western Coast, Yearly data',
                              'Pre-process' = perf_cmsy_preproc_otb_w,
                              'Model fit' = perf_cmsy_fit_otb_w,
                              'Output Render' = check-perf_cmsy_fit_otb_w)
save(perf_cmsy_w_otb, file = 'benchmarks/cmsy_otb_w_y.Rdata')
```
