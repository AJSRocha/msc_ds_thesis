...
grid.arrange(
  ...
  autoplot(ts_w_OTB_W, col = wes_palette('Zissou1',4)[4]) + theme_classic() + 
  labs(title = 'Weekly Series - Bottom Trawl fleet - West Coast',
       x = 'Year',
       y = 'landings (kg)'),
  
autoplot(ts_w_MIS_W, col = wes_palette('Zissou1',4)[3]) + theme_classic() + 
  labs(title = 'Weekly Series - Polyvalent fleet - West Coast',
       x = 'Year',
       y = 'landings (kg)'), 

autoplot(ts_w_OTB_S, col = wes_palette('Zissou1',4)[1]) + theme_classic() + 
  labs(title = 'Weekly Series - Bottom Trawl fleet - South Coast',
       x = 'Year',
       y = 'landings (kg)'),
autoplot(ts_w_MIS_S, col = wes_palette('Zissou1',4)[2]) + theme_classic() + 
