...
xtable(bet_total_w$estimates) %>% 
  print(.,
        type = "latex",
        file = "tables/res_jabba_est_mis_w.tex", 
        include.rownames = T,
        only.contents = T)
...
ggsave(fig, dpi = 300, units = 'cm',
       height = 10, width = 10, filename = 'plots/res_jabba_pardist_w.png')
...
xtable(bet_total_s$estimates) %>% 
  print(.,
        type = "latex",
        file = "tables/res_jabba_est_mis_s.tex", 
        include.rownames = T,
        only.contents = T)
...
fig = grid.grab()
ggsave(fig, dpi = 300, units = 'cm',
       height = 10, width = 10, filename = 'plots/res_jabba_pardist_s.png')
...
save(perf_jabba, file = 'benchmarks/jabba.Rdata')
save(bet_total_s, bet_total_w, file = 'tables/jabba_tables.Rdata')
