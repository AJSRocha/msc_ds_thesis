...
perf_jabba = data.frame(
  'Framework' = c('JABBA - Polyvalent, Western Coast, Yearly data',
                  'JABBA - Polyvalent, Southern Coast'),
  'Pre-process' = c(perf_jabba_preproc_mis_w, perf_jabba_preproc_mis_s),
  'Model fit' = c(perf_jabba_fit_mis_w, perf_jabba_fit_mis_s),
  'Output Render' = c(perf_jabba_render_mis_w, perf_jabba_render_mis_s))

save(perf_jabba, file = 'benchmarks/jabba_pella.Rdata')
save(bet_total_s, bet_total_w, file = 'tables/jabba_pella_tables.Rdata')
