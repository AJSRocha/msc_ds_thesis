...
id = data.frame(Continent = 'Europe',
                Region = 'Iberia',
                Subregion = 'Portugal',
                Stock = '1-Western Coast 1-Polyvalent',
                Group = 'Cephalopoda',
                Name = 'Octopus',
...
stocks = "1-Western Coast 1-Polyvalent"
...
for(stock in stocks) {
 ...
 #   bt           <- bt.raw
  ...
  time_f = Sys.time()
  perf_cmsy_fit_mis_w = time_f - time_i
...
time_f = Sys.time()
perf_cmsy_render_mis_w = time_f - time_i
check = time_f - total_i

```

```{r}
perf_cmsy_w_mis = data.frame('Framework' = 'CMSY++ - Polyvalent, Western Coast, Yearly data',
                              'Pre-process' = perf_cmsy_preproc_mis_w,
                              'Model fit' = perf_cmsy_fit_mis_w,
                              'Output Render' = check-perf_cmsy_fit_mis_w)
save(perf_cmsy_w_mis, file = 'benchmarks/cmsy_mis_w_y.Rdata')
```
