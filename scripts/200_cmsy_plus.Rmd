...
catch = data.frame(Stock = rep('occ.27.9.a.s.a.mis', nrow(effort_ns)),
                   yr = effort_ns$year_sale %>% as.character() %>% as.numeric(),
                   ct = effort_ns$catch/1000,
                   bt = effort_ns$effort)
