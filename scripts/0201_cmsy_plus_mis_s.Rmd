...
Alguns priors foram tirandos de
 https://www.sealifebase.se/summary/Octopus-vulgaris.html
...
id = data.frame(Continent = 'Europe',
                Region = 'Iberia',
                Subregion = 'Portugal',
                Stock = '2-Southern Coast 1-Polyvalent',
                Group = 'Cephalopoda',
                Name = 'Octopus',
...
stocks = "2-Southern Coast 1-Polyvalent"
...
for(stock in stocks) {
 ...
 #   bt           <- bt.raw
  ...
  cat("----------------------------------------------------------\n")
    ...
    time_f = Sys.time()
  perf_cmsy_fit_mis_s = time_f - time_i
...
time_f = Sys.time()
perf_cmsy_render_mis_s = time_f - time_i
check = time_f - total_i
```

```{r}
perf_cmsy_s_mis = data.frame('Framework' = 'CMSY++ - Polyvalent, Southern Coast, Yearly data',
                              'Pre-process' = perf_cmsy_preproc_mis_s,
                              'Model fit' = perf_cmsy_fit_mis_s,
                              'Output Render' = check - perf_cmsy_fit_mis_s)
save(perf_cmsy_s_mis, file = 'benchmarks/cmsy_mis_s_y.Rdata')
```
