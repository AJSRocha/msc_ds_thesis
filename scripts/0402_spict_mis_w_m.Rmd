...
png('plots/res_spict_data_mis_w_m.png', height = 10, width = 10, units = 'in', res = 300)
plotspict.data(res_spict)
dev.off()

png('plots/res_spict_res_mis_w_m.png', height = 10, width = 10, units = 'in', res = 300)
par(mfrow = c(2,2))
...
png('plots/res_spict_retro_mis_w_m.png', height = 10, width = 10, units = 'in', res = 300)
plotspict.retro(retro_res)
dev.off()

b = Sys.time()
spict_render_mis_w_m = b-a
```

# Performance 

```{r}
perf_spict_w_mis_m = data.frame('Framework' = 'SPiCT - Polivalent, Western Coast, Monthly data',
                              'Pre-process' = spict_preproc_mis_w_m,
                              'Model fit' = spict_fit_mis_w_m,
                              'Output Render' = spict_render_mis_w_m)
save(perf_spict_w_mis_m, file = 'benchmarks/spict_mis_w_m.Rdata')
```
